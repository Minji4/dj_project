...
class Post(models.Model):
    ...
    author = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, related_name='posts_written')
...
class Comment(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='posts_commented')
